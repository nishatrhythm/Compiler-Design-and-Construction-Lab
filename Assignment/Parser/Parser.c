...
int main(int argc,char **argv)
{
	...
	printf("Rules:\n1. Epsilon is represented by '#'\n2. Productions in form A=B (i.e. If Production is S->AB|C then you have to write S=AB, S=C)\n3. Each production of a non terminal is entered on a different line.\n4. Do not use '!' or '$' as they are reserved for special purposes.\n5. All input Strings have to end with a '$'.\n");
	printf("Example:\n\tE-> TR\n\tR-> +TR|# (epsilon)\n\tT-> FY\n\tY-> *FY|# (epsilon)\n\tF-> (E)|i\n");
	...
	scanf("%d",&count);
	printf("\nHello %s, enter %d productions in form A=B where A and B are grammar symbols :\n\n",name,count);
	for(i=0;i<count;i++)
	{
	    printf("%d. ",i+1);
